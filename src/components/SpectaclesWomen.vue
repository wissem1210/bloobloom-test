<template>
  <div class="collection-page" style="border: '1px solid #000'">
    ...
    <div class="collection-item collection-title">SPECTACLES WOMEN</div>
  ...
  computed: {
    collectionLink() {
      if (this.colour.length > 0 && this.shape.length > 0) {
        ...
        return "/spectacles-women/" + "?colour=" + this.colour.join("~");
      } else if (this.shape.length > 0) {
        return "/spectacles-women/" + "?shape=" + this.shape.join("~");
      } else {
